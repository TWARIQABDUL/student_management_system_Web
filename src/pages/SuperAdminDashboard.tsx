...
import AddCampusAdminForm from '../components/AddCampusAdminForm';
  ...
  return (
    <div className="flex min-h-screen bg-gray-50">
      ...
      <div className="flex-1 p-8">
                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                  <div className="flex items-center justify-between mb-6">
                    ...
                    <div className="flex space-x-3">
                      <button 
                        onClick={() => setActiveTab('add-campus-admin')}
                        className="flex items-center space-x-2 bg-white text-blue-600 border border-blue-600 px-4 py-2 rounded-lg hover:bg-blue-50 transition"
                      >
                        <UserPlus className="w-5 h-5" />
                        <span>Add Admin</span>
                      </button>
                      <button 
                        onClick={() => setActiveTab('add-campus')}
        ...
        {activeTab === 'add-campus' && (
          <AddCampusForm
            onSuccess={() => {
              setActiveTab('dashboard');
              loadData(); // Reload data to show new campus
            }}
            onCancel={() => setActiveTab('dashboard')}
          />
        )}

        {activeTab === 'add-campus-admin' && (
          <AddCampusAdminForm
